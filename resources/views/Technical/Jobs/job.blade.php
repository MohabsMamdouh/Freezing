    ...
    <section class="is-title-bar">
        ...
        >
          <ul>
            ...
            <li>
                @if (Route::currentRouteName() == 'Job.Current')
                    {{ __('public.Current Jobs') }}
                @endif

                @if (Route::currentRouteName() == 'Job.Finish')
                                    ...
                                    <li>
                                        ...
                                        <div class="timeline-body">
                                            <div class="timeline-header">
                                                ...
                                                @if ($job['status'] == 1)
                                                    <a href="{{ route('Job.updateStatus',['id' => $job['id']]) }}" class="pull-right text-success content-link" style="
                                                        background: #080;
                                                        margin-left: 15px;
