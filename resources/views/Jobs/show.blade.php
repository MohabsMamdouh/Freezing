                ...
                <li>
                    ...
                    <div class="timeline-body">
                        <div class="timeline-header">
                            ...
                            <a class="username" href="{{ Auth::user()->checkRole('Admin') ? route('ShowJob', ['id' => $jobs['id']]) : route('Job.Show', ['id' => $jobs['id']]) }}">
                                {{ $jobs['company_name'] }}
                                <small></small>
                            </a>
                            @if ($jobs['status'] == 1)
                                <a href="{{ Auth::user()->checkRole('Admin') ? route('updateStatus' ,['id' => $jobs['id']]) : route('Job.updateStatus' ,['id' => $jobs['id']]) }}" class="pull-right text-success content-link" style="
                                    background: #080;
                                    margin-left: 15px;
                            ...
                            @endif
                            <a href="{{ Auth::user()->checkRole('Admin') ? route('EditJob' ,['id' => $jobs['id']]) : route('Job.Edit' ,['id' => $jobs['id']]) }}" class="pull-right text-success content-link">
