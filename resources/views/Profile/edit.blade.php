        ...
        <div class="row">
            ...
            <div class="col-md-6 border-right">
                <div class="w-auto p-3">
                    <form action="{{ Auth::user()->checkRole('Admin') ? route('UpdateTechnicals') : route('Technical.Update') }}" method="post" enctype="multipart/form-data">
                        @csrf
