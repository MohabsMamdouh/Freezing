...
<div class="container">
    ...
    <div class="content-box">
        <form id="updateForm" action="{{ route('updateSetting') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col">
                    @if (strtolower(language()->getCode()) == 'en')
                        <div class="form-group">
                            ...
                            <input type="text" name="website_phone1" value="{{ $item->phone2 }}" class="form-control">
                    @elseif (strtolower(language()->getCode()) == 'ar')
                        <div class="form-group" style="text-align: right">
                            <label>{{ __('auth.Phone') }}</label>
